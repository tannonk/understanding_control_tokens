...
class BARTModel(TransformerModel):
    ...
    def forward(
        ...
        return_encoder_and_decoder_hidden_states=False, # modified to return encoder's inner states in addition to decoder's
        **kwargs,
    ):
        ...
        if return_encoder_and_decoder_hidden_states:
            # encoder_out.encoder_embedding.shape
            # torch.Size([1, 66, 1024])
            # (Pdb) p encoder_out.encoder_out.shape
